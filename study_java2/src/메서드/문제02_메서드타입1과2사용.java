...
class ScoreMng1{
	...
	void answerQ5(int[] arr, int score) {
	...
	void answerQ6(int[] hakbun,int[] score, Scanner sc) {
	...
	void answerQ7(int[] hakbun,int[] score, Scanner sc) {
...
public class 문제02_메서드타입1과2사용 {
	...
	public static void main(String[] args) {
		...
		sm.answerQ5(scores,score);
		// 문제6) 학번을 입력받아 성적 출력
		sm.answerQ6(hakbuns, scores, sc);
