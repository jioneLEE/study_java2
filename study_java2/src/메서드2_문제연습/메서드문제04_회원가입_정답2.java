...
class MemberController1 {
	...
	void printAllMember() {
		...
		for (String[] member : dao.memberList) {
			if (member[dao.no] == null) {
				break;
			}
	...
	void run() {
		...
		while (true) {
			int sel = dao.getInput("메뉴 선택하시오", 0);
			if (sel == 0) {
...
public class 메서드문제04_회원가입_정답2 {

	public static void main(String[] args) {

		MemberController1 menu = new MemberController1();
		menu.run();
