...
public class 클래스배열_기본이론1_2메모리그림 {
...
/////////////////////////////////////////////////////////////////////////////
		...
		// studentList의 첫번째 메모리방은 String 배열의 주소값만 들어간다 
				...
				String studentList1[][] = new String[3][];// {null, null ,null}

				String temp1[] = {"1001","박철수"}; // new String[2];
				studentList1[0] = temp1;
				
				System.out.println(studentList1[0][1]);
				
				
				// student 객체 3개가 들어가는 메모리방만 만든거지
				// student 객체 3개 만든것이 아니다!!! 
				
				stList = new Student[3]; // {null, null ,null}
				// stList에는 어떤 자료형만 들어갈 수 있나? ==> student 클래스 객체 주소값 
